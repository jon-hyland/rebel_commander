...
void CObjectManager::DefineObjectSeqs()
{
	...
	ObjEventDefs[BLIP_DEFAULT_ACTION][2]->iTargetX=800;
	...
	ObjEventDefs[BLIP_DEFAULT_ACTION][5]->iTargetX=150;
	...
	ObjEventDefs[BLIP_DEFAULT_ACTION][6]->iTargetX=300;
	...
	ObjEventDefs[BLIP_DEFAULT_ACTION][7]->iTargetX=480;
	...
	ObjEventDefs[BLIP_DEFAULT_ACTION][8]->iTargetX=800;
