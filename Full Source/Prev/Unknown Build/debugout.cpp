...
//			strlen(int2char(ObjectManager.ObjList[0]->GetY(), cint)));
		...
		//level time
		y=0+(line_count++ * 17);
		TextOut(hdc,0,y,"level time=", strlen("level time="));
		TextOut(hdc,130,y,int2char(Timer.GameTime() - LevelStartTime, cint),
			strlen(int2char(Timer.GameTime() - LevelStartTime, cint)));
		...
		//level events left
		y=0+(line_count++ * 17);
		TextOut(hdc,0,y,"events left=", strlen("events left="));
		TextOut(hdc,130,y,int2char((LevelEventsTotal - LevelEventsExecuted), cint),
			strlen(int2char((LevelEventsTotal - LevelEventsExecuted), cint)));
