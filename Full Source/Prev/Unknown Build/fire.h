...
public:
	CFire(FireType firetype, int orig_x, int orig_y, int target_x, int target_y, float vector_speed);
	void Move();
	void DrawBlit(LPDIRECTDRAWSURFACE surface);
	void DrawPlot(DDSURFACEDESC *ddsd);
