...
{
	BOOL result=TRUE;
	result=result&&g_pSprite[SHIP_SPRITE]->load(&g_cShipSprites,0,3,3);
	result=result&&g_pSprite[SHIP_SPRITE]->load(&g_cShipSprites,1,96,3);
	result=result&&g_pSprite[SHIP_UP_SPRITE]->load(&g_cShipSprites,0,189,3);
	result=result&&g_pSprite[SHIP_UP_SPRITE]->load(&g_cShipSprites,1,282,3);
	result=result&&g_pSprite[SHIP_DOWN_SPRITE]->load(&g_cShipSprites,0,375,3);
	result=result&&g_pSprite[SHIP_DOWN_SPRITE]->load(&g_cShipSprites,1,468,3);
...
BOOL LoadBlipSprite()
{
	...
	result=result&&g_pSprite[BLIP_SPRITE]->load(&g_cBlipSprites,0,3,3);
	result=result&&g_pSprite[BLIP_SPRITE]->load(&g_cBlipSprites,1,42,3);
	result=result&&g_pSprite[BLIP_SPRITE]->load(&g_cBlipSprites,2,81,3);
	result=result&&g_pSprite[BLIP_SPRITE]->load(&g_cBlipSprites,3,120,3);
	return result;
}
...
BOOL LoadImages()
{
	...
	g_pSprite[SHIP_SPRITE]=new CClippedSprite(2,90,60);
	g_pSprite[SHIP_UP_SPRITE]=new CClippedSprite(2,90,60);
	g_pSprite[SHIP_DOWN_SPRITE]=new CClippedSprite(2,90,60);
	if(!LoadShipSprite()) return FALSE;
	
	g_pSprite[BLIP_SPRITE]=new CClippedSprite(4,36,36);
