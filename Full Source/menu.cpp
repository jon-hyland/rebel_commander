...
void ComposeMenuFrame()
{
	...
	if(MenuSelection==4) 
		Alpha.Write(lpSecondary,540,240,"jump to level two",BLUE_ALPHA_SPRITE);
	else
		Alpha.Write(lpSecondary,540,240,"jump to level two",RED_ALPHA_SPRITE);
	if(MenuSelection==5) 
		Alpha.Write(lpSecondary,540,259,"jump to level three",BLUE_ALPHA_SPRITE);
	else
		Alpha.Write(lpSecondary,540,259,"jump to level three",RED_ALPHA_SPRITE);
	if(MenuSelection==6) 
