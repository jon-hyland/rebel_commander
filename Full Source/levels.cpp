...
void StartLevelOne()
{
	...
	LevelEventCount=DefineLevelOneEvents();
	LevelEventsDone=0;
	Invincible=FALSE;
...
void StartLevelTwo()
{
	...
	Ship.Create(300,230);	
	LevelStartTime=Timer.GameTime();
	//LevelEventCount=DefineLevelTwoEvents();
	LevelEventsDone=0;
}
...
void StartLevelThree()
{
	...
	Ship.Create(300,230);	
	LevelStartTime=Timer.GameTime();
	//LevelEventCount=DefineLevelThreeEvents();
	LevelEventsDone=0;
}
...
/*	if(LevelEventsDone>=LevelEventCount)
	{
		switch(GameState)
		{
			case LEVEL_ONE:
